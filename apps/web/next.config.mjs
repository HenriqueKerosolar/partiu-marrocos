...
const nextConfig = {
  ...
  // O site público deixou de ser um deploy Vercel separado atrás de um
  // proxy Multi Zones — agora é a própria home do app (src/app/(public)/),
  // com o mesmo login/sessão do CRM. Ver git log pra o histórico do setup
  // anterior (rewrites pro projeto partiu-marrocos-site), removido aqui.
};
